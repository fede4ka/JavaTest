INSERT INTO usr  (username, password, active) VALUES ('user', 'password', TRUE),
                    ('Ivan', 'ivanpassword', TRUE);

INSERT INTO user_role(roles) VALUES ('USER'),('USER'),('USER');
INSERT INTO usr_info (name,lastname,age) VALUES ('Буратино','Богатый',20),
('Иван','Петров',18);
